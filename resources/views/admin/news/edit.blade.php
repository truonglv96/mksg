...
$breadcrumbs = [
    ...
    ['label' => 'Chỉnh sửa', 'url' => route('admin.news.edit', $news->id ?? '')]
];
@endphp
    ...
    <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 flex items-center">
                <i class="fas fa-edit mr-3" style="color: #2563eb;"></i>
                Chỉnh sửa tin tức
            </h1>
            <p class="mt-1 text-sm text-gray-500">Cập nhật thông tin tin tức</p>
        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Nhập mô tả ngắn về tin tức">{!! old('description', $news->description) !!}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea name="content" 
                                          ...
                                          placeholder="Nhập nội dung chi tiết của tin tức">{!! old('content', $news->content) !!}</textarea>
                                <button type="button" 
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="meta_description" 
                                      ...
                                      placeholder="Nhập mô tả ngắn cho SEO (tối đa 500 ký tự)">{{ old('meta_description', $news->meta_description) }}</textarea>
            ...
            <div class="space-y-6">
                                    ...
                                    <label class="flex items-center cursor-pointer py-2 px-3 rounded-lg transition-all duration-200 hover:bg-gradient-to-r hover:from-red-50 hover:to-blue-50 group">
                                        <div class="relative flex items-center flex-1">
                                            <input type="checkbox" 
                                                   ...
                                                   value="{{ $cat['id'] }}"
                                                   id="cat_{{ $cat['id'] }}"
                                                   {{ in_array($cat['id'], old('categories', $newsCategoryIds ?? [])) ? 'checked' : '' }}
                ...
                <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <div class="image-upload-area" id="imageUploadArea" onclick="document.getElementById('url_img').click()">
                        ...
                        <div id="uploadPlaceholder" class="{{ $news->url_img ? 'hidden' : '' }}">
                        ...
                        <div id="imagePreview" class="{{ $news->url_img ? '' : 'hidden' }}">
                            <div class="image-preview-container">
                                <img id="previewImage" 
                                     src="{{ $news->url_img ? asset('img/news/' . $news->url_img) : '' }}" 
                                     alt="Preview" 
                                     class="preview-image">
                            ...
                            <div class="mt-3">
                                <label class="flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-2 text-sm text-red-600">Xóa ảnh hiện tại</span>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" 
                                   name="weight" 
                                   value="{{ old('weight', $news->weight ?? 0) }}"
                                   min="0"
                        ...
                        <div>
                            <label class="flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       name="hidden" 
                                       value="1"
                                       {{ old('hidden', $news->hidden) == 1 ? 'checked' : '' }}
                                       class="w-4 h-4 text-red-600 border-gray-300 rounded focus:ring-red-500">
