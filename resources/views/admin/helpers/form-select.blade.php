@php
    ...
    $selectClass = 'w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-smooth bg-white appearance-none cursor-pointer ' . $class;
@endphp
